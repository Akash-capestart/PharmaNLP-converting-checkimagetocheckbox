                ...
                {activeIdToAddTag === article.refId ?
                  <>
                    <div className="position-relative pad-r-10 btn-width-animation">
                      <input placeholder="Add Tag" className="tag-add-input-active w-100" autoFocus onChange={(e) => tagInputChangeHandler(e.target.value)} onKeyDown={(e) => enterKeyPressHandler(e, article.refId)} />
                      {activeIdToAddTag === article.refId &&
