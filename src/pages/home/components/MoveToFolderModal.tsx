...
import { FolderColorSelectorDropDown } from "../../../commonComponents/FolderColorSelectorDropDown";
...
export function MoveToFolderModal({ closeModalHandler } : MoveToFolderModalProps) {
  ...
  const changeFolderColorHandler = (val : string) => setactiveDropDownVal(val);
