...
export function SideMenuFolderLists({ filesData, sideBarPinned }: FilesDataProps) {
  ...
  const accToggleHandler = () => setsideMenuForderListsState(prevVal => ({
    ...prevVal,
  ...
  return (
    <div style={{ padding: "0px 5px 5px 5px" }}>
      <div
        className={`d-flex align-items-center ${!sideBarPinned ? "justify-content-start" : "justify-content-center"} cursor-pointer light-green-background pad-5`}
